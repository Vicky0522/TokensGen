...
#from i2vedit.utils.convert_diffusers_to_original_ms_text_to_video import convert_unet_state_dict, convert_text_enc_state_dict_v20
...
from longvgen.models.unet_vc2_vip_v10 import UNetVC2VIPV10Model
...
class LoraHandler(object):
    ...
    def save_cloneofsimo_lora(self, model, save_path, step, flag):
        ...
        save_lora(
            model.unet if hasattr(model, 'unet') else model, 
            FILE_BASENAMES[0], 
            self.use_unet_lora, 
